...
public class UserBarView extends FrameLayout implements View.OnClickListener {
    ...
    public UserBarView(@NonNull Context context) {
        super(context);
        thisContext = context;
        setUp();
    ...
    public UserBarView(@NonNull Context context, AttributeSet attributeSet) {
    ...
    private void onBtn1Click() {
        thisContext.startActivity(new Intent(thisContext, MyProjectMainActivity.class));
    }
